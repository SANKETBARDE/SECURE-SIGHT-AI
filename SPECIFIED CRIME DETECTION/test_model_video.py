...
# ✅ Label Mapping
label_mapping = {0: "Assault", 1: "Robbery"}

# ✅ Video path and model path
video_path = 'C:/Users/Lenovo/OneDrive/Desktop/ALLCRIME/axault.mp4'      # CHANGE THIS
model_path = 'C:/Users/Lenovo/OneDrive/Desktop/ALLCRIME/best_model.pth'    # CHANGE THIS
...
with torch.no_grad():
    ...
    print(f"📊 Class probabilities → Assault: {probs[0][0].item():.4f}, Robbery: {probs[0][1].item():.4f}")
