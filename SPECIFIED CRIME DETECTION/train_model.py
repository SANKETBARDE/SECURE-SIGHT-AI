...
def get_label_mapping(root_dir):
...
class CrimeFramesDataset64(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frames = torch.stack(frames)  # [T, 3, 64, 64]
        return frames, label
...
# ✅ Configurations
root_path = "C:/Users/Lenovo/OneDrive/Desktop/ALLCRIME/UCF_Crime_Dataset/Train"
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
epochs = 5
batch_size = 4

label_mapping = get_label_mapping(root_path)
